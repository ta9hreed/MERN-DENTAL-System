...
export const getCountDoctors = catchAsyncErrors(async (req, res, next) => {
...
// Your function to get user details
...
export const updateUser = catchAsyncErrors(async (req, res, next) => {
  ...
  try {
    ...
    // Update user data
    user.set(req.body); // Set fields from request body
    await user.save(); // Save updated user

    res.status(200).json({
      success: true,
      message: "User updated successfully",
      data: user, // Optionally, send updated user data in the response
    });
  } catch (error) {
    // Handle errors
